...
export const NominatesType = {
  StreamerYear: "StreamerYear",
  DownYear: "DownYear",
  WhoreYear: "WhoreYear",
  FaggotYear: "FaggotYear",
  PedophileYear: "PedophileYear",
};

export const OrderNominations = [
  NominatesType.StreamerYear,
  NominatesType.DownYear,
  NominatesType.WhoreYear,
  NominatesType.FaggotYear,
  NominatesType.PedophileYear,
];

export const NominatesData = {
  [NominatesType.StreamerYear]: {
    title: "Стример года",
    nominated: NominatedData1,
  },
  [NominatesType.DownYear]: {
    title: "Даун года",
    nominated: NominatedData2,
  },
  [NominatesType.WhoreYear]: {
    title: "Шлюха года",
    nominated: NominatedData3,
  },
  [NominatesType.FaggotYear]: {
    title: "Пидор года",
    nominated: NominatedData4,
  },
  [NominatesType.PedophileYear]: {
    title: "Педофил года",
    nominated: NominatedData5,
  },
};
